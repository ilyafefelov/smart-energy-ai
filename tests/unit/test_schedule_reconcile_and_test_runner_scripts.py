...
def test_read_dagster_schedule_helpers_and_main(monkeypatch, capsys, tmp_path: Path) -> None:
    ...
    rows = [
        {"hour": 2, "action_kw": -1.25, "net_cost_eur": 3.0, "price_eur_mwh": 100.0, "solver": "milp", "client_id": "tenant-b", "soc_before_kwh": 80.0, "grid_export_kwh": 0.0, "forecast_run_id": "forecast-demo", "forecast_model_name": "promoted_model", "forecast_model_family": "random_forest_regressor", "forecast_model_version": "registry:promoted_model", "forecast_horizon_mode": "conservative", "forecast_uncertainty_source": "walk_forward_residual_std", "forecast_promotion_active": True, "forecast_promotion_source": "forecast_value_benchmark_asset", "forecast_window_start_utc": "2026-03-29T00:00:00+00:00", "optimization_run_id": "optimization-demo-b"},
        {"hour": 0, "action_kw": 1.5, "net_cost_eur": -4.0, "price_eur_mwh": 120.0, "solver": "milp", "client_id": "tenant-a", "soc_before_kwh": 100.0, "grid_export_kwh": 0.4, "forecast_run_id": "forecast-demo", "forecast_model_name": "promoted_model", "forecast_model_family": "random_forest_regressor", "forecast_model_version": "registry:promoted_model", "forecast_horizon_mode": "conservative", "forecast_uncertainty_source": "walk_forward_residual_std", "forecast_promotion_active": True, "forecast_promotion_source": "forecast_value_benchmark_asset", "forecast_window_start_utc": "2026-03-29T00:00:00+00:00", "optimization_run_id": "optimization-demo-a"},
        {"hour": 1, "action_kw": 0.0, "net_cost_eur": 0.5, "price_eur_mwh": 110.0, "solver": "milp", "client_id": "tenant-a", "soc_before_kwh": 99.0, "grid_export_kwh": 0.0, "forecast_run_id": "forecast-demo", "forecast_model_name": "promoted_model", "forecast_model_family": "random_forest_regressor", "forecast_model_version": "registry:promoted_model", "forecast_horizon_mode": "conservative", "forecast_uncertainty_source": "walk_forward_residual_std", "forecast_promotion_active": True, "forecast_promotion_source": "forecast_value_benchmark_asset", "forecast_window_start_utc": "2026-03-29T00:00:00+00:00", "optimization_run_id": "optimization-demo-a"},
    ]
    ...
    assert schedule[0]["optimization_run_id"] == "optimization-demo-a"
    ...
    assert payload["schedule"][0]["forecast_run_id"] == "forecast-demo"
    assert payload["schedule"][0]["forecast_model_name"] == "promoted_model"
    assert payload["schedule"][0]["forecast_model_version"] == "registry:promoted_model"
    assert payload["schedule"][0]["forecast_promotion_active"] is True
    assert payload["schedule"][0]["optimization_run_id"] == "optimization-demo-a"
    assert payload["schedule_start_utc"] == "2026-03-29T00:00:00+00:00"
