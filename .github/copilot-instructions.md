...
- `energy_ml/pipeline.py` live-context battery parsing and fallback behavior is covered by `tests/unit/test_optimizer_and_pipeline_surfaces.py`; preserve alias support for `soc`/`health` battery keys when thinning that module.
