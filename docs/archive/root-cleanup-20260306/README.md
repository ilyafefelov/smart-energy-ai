...
Archived on 2026-03-06 during the second cleanup pass.

This archive contains root-level one-off artifacts that were no longer part of the active runtime or documentation surface:
