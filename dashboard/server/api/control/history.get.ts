...
function normalizeHistoryEntries(
  ...
  .map((entry: any) => {
    ...
    return {
      ...
      forecast_run_id: normalizeOptionalString(entry?.forecast_run_id),
      forecast_model_version: normalizeOptionalString(entry?.forecast_model_version),
      optimization_run_id: normalizeOptionalString(entry?.optimization_run_id),
